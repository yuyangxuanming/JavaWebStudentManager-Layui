...
<body>
<br>
<center><p style="color: black; font-size: 30px;">教师信息管理</p></center>
    ...
    layui.use(['table', 'layer', 'form'], function(){
        ...
        const tableIns = table.render({
            ...
            ,cols: [[
                ...
                ,{field:'id', width: '10%', title: '教师ID', sort: true, align:'center', fixed:'left'}
                ,{field:'name', width: '15%', title: '教师姓名', align:'center'}
                ,{field:'sex', width: '10%', title: '教师性别', align:'center'}
                ,{field:'mobile', width: '30%', title: '教师手机', align:'center'}
                ,{field:'email', width: '30%', title: '教师邮箱', align:'center'}
